# Upload Freepaper v2.0.5 to GitHub

This folder is the cleaned public repository package for Freepaper v2.0.5.
It intentionally omits old intermediate patch files and obsolete per-version test documents.

## Recommended repository name

Use `Freepaper` as the repository name. Keep software versions in Git tags/releases such as `v2.0.5` rather than in the repository name.
...
7. Use a commit message such as `Release Freepaper v2.0.5`.
8. After the files are updated, create a GitHub Release/Tag named `v2.0.5`.
...
git status
git add -A
git commit -m "Release Freepaper v2.0.5"
git push origin main
```

Then create the `v2.0.5` Release on GitHub.
