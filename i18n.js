...
(() => {
  ...
  const messages = {
    en: {
      versionLabel: 'v1.4.0 · Bilingual interface and new icon',
      refreshStatus: 'Refresh status', settings: 'Settings', openSettings: 'Open settings', closeSettings: 'Close settings',
      currentPageTab: '📄 Current page', batchDownloadTab: '📋 Batch download', ready: 'Ready',
      sdNeedsAction: '🤖 ScienceDirect needs your action', waiting: 'Waiting…', continueAfterAction: '✓ I’m done, continue',
      ...
      autoMonitorTitle: 'Open download monitor when verification is required',
      autoMonitorHint: 'Off by default. Open it from the main panel to avoid unnecessary pop-ups.',
      ...
      sd_WAITING_CHALLENGE_2: 'A second verification appeared in the PDF stage. Complete it, then click Continue.',
      sd_WAITING_MANUAL_PDF: 'Click View PDF / Download PDF on the task page, then click Continue.',
      ...
      phaseChallenge1: 'First verification', phaseChallenge2: 'Second verification', phaseManual: 'Manual action', phaseAccess: 'Restore access', phaseAction: 'Action required',
      overlayTitle: 'Freepaper verification assistant', dragToMove: 'Drag to move', overlayDefaultMessage: 'Complete the required action on this page.',
    ...
    zh_CN: {
      versionLabel: 'v1.4.0 · 中英文与新图标版',
      refreshStatus: '刷新状态', settings: '设置', openSettings: '打开设置', closeSettings: '关闭设置',
      currentPageTab: '📄 当前页面', batchDownloadTab: '📋 批量下载', ready: '就绪',
      sdNeedsAction: '🤖 ScienceDirect 需要你的操作', waiting: '等待中…', continueAfterAction: '✓ 我已完成，继续',
      ...
      autoMonitorTitle: '验证时自动打开下载进程窗', autoMonitorHint: '默认关闭。关闭时由主面板手动调出，避免窗口打扰。',
      ...
      sd_OPENING: '正在打开论文页面…', sd_ARTICLE_READY: '文章页已就绪，正在打开 PDF…', sd_OPENING_PDF: '正在打开 PDF 页面…',
      sd_PDF_PAGE_READY: 'PDF 页面已就绪，正在验证并下载…', sd_CHECKING_AFTER_CHALLENGE: '正在等待页面跳转稳定并重新检测…',
      sd_WAITING_CHALLENGE_1: '请完成第一次安全验证，然后点击继续。', sd_WAITING_CHALLENGE_2: 'PDF 页面出现第二次安全验证，请完成后点击继续。',
      sd_WAITING_MANUAL_PDF: '请手动点击 View PDF / Download PDF，然后点击继续。', sd_ACCESS_DENIED: '访问被拒绝，请检查机构登录或 VPN。',
      sd_DONE: '当前论文已下载。', sd_FAILED: '当前论文下载失败。', sd_STOPPED: '当前论文已停止。', processing: '处理中…',
      phaseChallenge1: '第一级验证', phaseChallenge2: '第二级验证', phaseManual: '需要手动操作', phaseAccess: '访问恢复', phaseAction: '需要操作',
      overlayTitle: 'Freepaper 页面验证助手', dragToMove: '按住拖动', overlayDefaultMessage: '请完成当前页面操作',
